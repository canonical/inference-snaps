...
For installation instructions, check out [Open WebUI][open-webui-install].
...
To find the correct URL, check out this guide on {ref}`using an AI model snap via its OpenAI API <use-openai-api>`.
